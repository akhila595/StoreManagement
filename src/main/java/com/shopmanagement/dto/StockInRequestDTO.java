...
public class StockInRequestDTO {
    ...
    public Long getClothTypeId() { return clothTypeId; }
    public void setClothTypeId(Long clothTypeId) { this.clothTypeId = clothTypeId; }
    ...
    public BigDecimal getTaxPerUnit() { return taxPerUnit; }
    public void setTaxPerUnit(BigDecimal taxPerUnit) { this.taxPerUnit = taxPerUnit; }

    public BigDecimal getTransportPerUnit() { return transportPerUnit; }
    public void setTransportPerUnit(BigDecimal transportPerUnit) { this.transportPerUnit = transportPerUnit; }
